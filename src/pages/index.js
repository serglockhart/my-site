        ...
        <Content>
          ...
          >
              ...
              body={
                <ul className="tech">
                  <li>
                    ...
                    configurations (video containers/codecs) for entire East
                    Coast feed
                  </li>
                  <li>
            ...
            <Card
              ...
              body={
                <ul className="tech">
                  ...
                  <li>
                    Will work with IDEA Center startups to develop full-stack
                    web apps and APIs in Agile Environment
                  </li>
                </ul>
              }
              end={
              ...
              body={
                <ul className="tech">
                  <li>
                    ...
                    accelerator invitation, and pitch to Indianapolis-based
                    $100M VC fund
                  </li>
                  <li>
                    Solely developed front-end of web app and will integrate
                    with Node + Flask backend through Parse Server
                  </li>
                  <li>
                    Developing RESTful API, and will integrate with drone GCS
                    and NoSQL database in Agile Environment
                  </li>
                </ul>
              }
              end={
                <p>
                  <strong>Technologies</strong>: JavaScript, React, Node,
                  Express, Python, Flask, MongoDB, AWS (Elastic Beanstalk, IoT),
                  Parse Server, Sass/SCSS, Bootstrap, HTML/CSS, Raspberry Pi,
                  Agile (SCRUM), PWA, Git
                </p>
              }
            />
            ...
            <Card
              ...
              body={
                <ul className="tech">
                  ...
                  <li>
                    Solely developed indoor location triangulation mobile
            ...
            <Card
              ...
              body={
                <ul className="tech">
                  ...
                  <li>
                    ...
                    <a
                      ...
                      target="_BLANK"
                    >
                      National Seed Fund (NSF) Small Business Innovation
                      Research (SBIR)
                    </a>{" "}
                    program entry
                  </li>
                ...
                <p>
                  <strong>Technologies</strong>: C++, Arduino, Javascript,
                  React, Gatsby, GraphQL, Netlify, Sass/SCSS, Bootstrap,
                  HTML/CSS, PWA, Git
                </p>
              }
            />
            <Card
              ...
              body={
                ...
                <p>
                  ...
                  Heroku, JavaScript, jQuery, Sass/SCSS, Bootstrap, HTML/CSS
                </p>
              }
            />
            <Card
              ...
              body={
                <ul className="tech">
                  <li>
                    Organized national hackathon, international summit attended
                    by 5 countries and 10-week startup incubator program for 9
          ...
          <Section id="extracurriculars" title="Extracurriculars">
            <Card
              ...
              body={
                <p>
                  Standing for Innovation, De-Risking and Enterprise
                  Acceleration, the{" "}
                  <a
                ...
                <ul>
                  <li>
                    Aided in recruiting students for summer internships,
                    McCloskey New Venture Competition, and academic programs
                  </li>
                  <li>
                    Connected College of Engineering students to affiliated
                    local startups and business plan teams
                  </li>
                  <li>
                    Researched on marketing and recruitment strategies for
            ...
            <Card
              ...
              body={
                <p>
                  ...
                  whether one should practice a religion, and what sacrifices
                  one should make for others.
                </p>
              }
              end={
                <ul>
                  <li>
                    Oversaw 21 students through graded group discussions and
                    major requirements of 3-credit course (20-page essay and
          ...
          <Section id="projects" title="Projects">
            ...
            <Project
              ...
              body="Startup company landing page (PWA) for Tembo AI, LLC set up for heavier SSR full stack web app workload."
                ...
                <p>
                  ...
                  Sass, Bootstrap, Now, Mapbox, Mailchimp, Formspree, Google
                  Analytics, PWA
                </p>
              }
              buttons={
            ...
            <Project
              ...
              body="Portfolio website (PWA) for fashion designer Kyra Buenviaje displaying resume, projects and collections."
                ...
                <p>
                  <strong>Technologies:</strong> React, Gatsby,
            ...
            <Project
              ...
              body="Personal website (PWA) displaying resume and projects inspired by a simple, software project-friendly LinkedIn profile."
                ...
                <p>
                  <strong>Technologies:</strong> React, Gatsby,
                  styled-components, Bootstrap, Netlify, Getform, Google
                  Analytics, PWA
                </p>
              }
              buttons={
